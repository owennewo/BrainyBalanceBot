...
int LSM6DS3Class::begin()
{
  ...
  //   writeRegister(LSM6DS3_CTRL2_G, 0x4C); // 2000dps
  writeRegister(LSM6DS3_CTRL2_G, 0x44);     // 500dps
...
//   writeRegister(LSM6DS3_CTRL7_G, 0x70);  // high pass filter 
...
int LSM6DS3Class::readGyroscope(float& x, float& y, float& z)
{
  ...
  // 16 bit signed is -32,768 to 32,767.  We need to convert that to what ever dps range we've configured e.g. +-2000 or +-500

  x = data[0] * 500.0 / 32768.0;
  y = data[1] * 500.0 / 32768.0;
  z = data[2] * 500.0 / 32768.0;
